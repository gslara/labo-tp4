            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        query = "UPDATE empleados SET legajo = " + req.body.Legajo + ", apellido = '" + req.body.Apellido + "', nombre = '" + req.body.Nombre + "', dni = " + req.body.Dni + ", sector = '" + req.body.Sector + "', fecha_ingreso = NULL, activo = " + req.body.Activo + " WHERE legajo = " + req.body.Legajo;
